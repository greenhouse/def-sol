__fname = '_abi' # ported from 'snow' (020725)
...
CALLIT_FUNC_MAP_WRITE = {
	"#------------SNOW------------#": ["xxxxxxxx", [], []],     
    "bridgeIn(tuple)": ["0x7b345a2b", [], []], # uint32 = execution loop count
    
    "#------------ATROPA------------#": ["xxxxxxxx", [], []],     
    "unknown()_0xa4566950": ["a4566950", [], []],
	"callFunction(uint32)": ["0x820f9184", [], []], # uint32 = execution loop count
